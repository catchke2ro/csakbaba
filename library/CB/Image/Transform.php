 ...
 * @see CB_Image_Image
 */
require_once 'CB/Image/Image.php';

/**
 * @see CB_Image_Transform_Exception
 */
require_once 'CB/Image/Transform/Exception.php';
 ...
 * @license   http://www.opensource.org/licenses/bsd-license.php New BSD License
 */
class CB_Image_Transform extends CB_Image_Image
{
    /**
     ...
     *
     * @throws CB_Image_Driver_Exception
     * @throws CB_Image_Transform_Exception
    ...
    public function fitToWidth( $targetWidth )
    {
        ...
        if( $sourceWidth <= 0 ) {
            throw new CB_Image_Transform_Exception( 'Source width can\'t be 0' );
        }

        if( $sourceHeight <= 0 ) {
            throw new CB_Image_Transform_Exception( 'Source height can\'t be 0' );
        }
    ...
    private function _checkOffsets()
    {
        if( $this->_leftOffset > 0 && $this->_rightOffset > 0 ) {
            throw new CB_Image_Transform_Exception(
