...
class CB_Resource_Navigation extends Zend_Navigation {
	...
	function initNavigation(){
		$this->addPages(array(
			...
			array('label'=>'Szolgáltatások', 'uri'=>'/szolgaltatasok', 'mvc'=>array('market','indexszolg'), 'resource'=>'piacszolg'),
			...
			array('label'=>'Asztalom', 'notValid'=>array('label'=>'Oldalam'), 'class'=>'user', 'uri'=>'/felhasznalo', 'mvc'=>array('user', 'index'), 'resource'=>'felhasznalo', 'noindex'=>true, 'visible'=>true, 'pages'=>array(
				...
				array('label'=>'Szolgáltatásaim', 'notValid'=>array('label'=>'Asztalnyitás', 'url'=>'/felhasznalo/adatmodositas?nyitas=1'), 'uri'=>'/felhasznalo/szolgaltatasok', 'mvc'=>array('shop','userservices'), 'resource'=>'felhasznaloszolgaltatasok', 'visible'=>true),
